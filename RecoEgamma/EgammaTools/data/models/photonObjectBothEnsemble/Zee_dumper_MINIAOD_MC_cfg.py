...
#process.patPhotonsDRN.Client.modelName = cms.string("photonObjectBothEnsemble")  # Must match the Triton model name
#process.patPhotonsDRN.Client.modelConfigPath = cms.FileInPath("Test/RecoEgamma.EgammaPhotonProducers.TritonModels/models/photonObjectEnsemble/config.pbtxt")  # Local path
#process.patPhotonsDRN.Client.modelName = cms.string("photonObjectCombined")  # Must match the Triton model name
#process.patPhotonsDRN.Client.modelConfigPath = cms.FileInPath("RecoEgamma/EgammaPhotonProducers/data/models/photonObjectBothEnsemble/config.pbtxt")  # Local path
#process.patPhotonsDRN.Client.modelConfigPath = cms.FileInPath("~sosaha/public/models/photonObjectBothEnsemble/config.pbtxt")  # Local path
