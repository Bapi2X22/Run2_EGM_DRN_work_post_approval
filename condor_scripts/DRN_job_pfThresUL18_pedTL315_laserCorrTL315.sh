...
cd /eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/condor_scripts_pfThresUL18_pedTL315_laserCorrTL315 
...
# output_folder="/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/condor_scripts_pfThresUL18_pedTL315_laserCorrTL315/pfThresUL18_pedTL315_laserCorrTL315"
# small_files=()
# corrupted_files=()
# for i in "${files[@]:$3:$4}"
# do
...
output_folder="/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/condor_scripts_pfThresUL18_pedTL315_laserCorrTL315/pfThresUL18_pedTL315_laserCorrTL315/$1"
