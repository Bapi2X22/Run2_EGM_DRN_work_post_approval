...
export CMSSW_SEARCH_PATH=${CMSSW_SEARCH_PATH}:/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/RecoEgamma/EgammaTools/plugins
cmsRun ${LOCALTOP}/src/HeterogeneousCore/SonicTriton/test/MytritonTest_cfg.py modules=PatPhotonDRNCorrectionProducer maxEvents=2 unittest=1 verbose=1 device=${DEVICE} testother=1 fallbackName=${fallbackName} >& $tmpFile
CMSEXIT=$?
